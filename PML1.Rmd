...
data_dir <- "C://Users//MAHE//Documents//PMLData//"
pathAnswers <- "C://Users//MAHE//Documents//PMLData//"
```
...
```{r load_prep_call}
pml_CSV<- read.csv("C://Users//MAHE//Documents//PMLData//pml-training.csv", header=TRUE, sep=",", na.strings=c("NA",""))
...
```{r GetTestData}
pml_CSV  <- read.csv("C://Users//MAHE//Documents//PMLData//pml-testing.csv", header=TRUE, na.strings=c("NA",""))
pml_CSV <- pml_CSV[,-1] # Remove the first column that represents a ID Row
